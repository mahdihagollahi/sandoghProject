...
function AdminHeader() {
  return (
    <div  className='w-full'>
        <div className=' flex flex-col md:flex-row justify-between bg-[#FFFFFF] mt-4 mr-20 ml-3 md:mr-20 md:ml-3  lg:mr-20 lg:ml-3  xl:mr-96 xl:ml-4 rounded-md shadow-2xl   py-3 px-6 h-auto md:h-16'>
