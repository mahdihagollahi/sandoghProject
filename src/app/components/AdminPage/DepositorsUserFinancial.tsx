...
const fakeUsers: User[] = [
  { id: 1, name: "علی رضایی", joinDate: "2023-01-01", depositAmount: 500000 },
  { id: 2, name: "محمد حسینی", joinDate: "2023-02-15", depositAmount: 750000 },
  { id: 3, name: "فاطمه موسوی", joinDate: "2023-03-10", depositAmount: 300000 },
];
...
const DepositorsUserFinancial: React.FC = () => {
  ...
  return (
    <div>
      ...
      <UserTableDespositors users={fakeUsers} />
    </div>
  );
};
