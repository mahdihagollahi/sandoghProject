        ...
        <div className="mt-10">
          ...
          <div className="flex">
            ...
            <div className="relative w-full md:w-auto">
              ...
              <input
                type="text"
                value={userDetail.importantPhoneNumber || ""}
                className="border w-96 md:w-96 h-14 border-[#CACACA] rounded-md relative m-3"
              />
            </div>
          </div>
          ...
          <div className="flex">
            ...
            <div className="relative w-full md:w-auto">
              ...
              <input
                type="text"
                value={userDetail.nationalNumber || ""}
                className="border w-96 md:w-96 h-14 border-[#CACACA] rounded-md relative m-3"
              />
            </div>
          </div>
...
// گرفتن اطلاعات از سرور با استفاده از getServerSideProps
