...
const DetailUser: React.FC<{ userId: string }> = ({ userId }) => {
  ...
  if (loading) {
    return (
      <div>
        ...
        <div className="bg-white w-full h-20 shadow-md mt-5  cursor-pointer rounded-sm">
  ...
  return (
    <div>
      ...
      <div className="bg-white shadow-md mt-5 px-28 py-20 cursor-pointer rounded-sm">
